...
function activeCoachRelationships(context = {}) {
  ...
  return relationships.filter((relationship) => {
    ...
    const status = lower(relationship.status || relationship.accountStatus || relationship.relationshipStatus || "active");
    return relationship.active !== false && relationship.isActive !== false && status !== "inactive" && status !== "removed";
  });
}
